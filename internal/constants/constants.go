...
const (
	...
	AppStoreServiceAppURLTempl        = "https://%s:%s/app-store-server/v1/application/%s?version=%s"
	...
	AppStoreServiceAppTypesURLTempl   = "https://%s:%s/app-store-server/v1/applications/types?version=%s"
	AppStoreServiceAppExistURLTempl   = "https://%s:%s/app-store-server/v1/applications/exist/%s"
	AppStoreServiceAppListURLTempl    = "https://%s:%s/app-store-server/v1/applications?page=%s&size=%s&version=%s"
	AppStoreServiceAppTopURLTempl     = "https://%s:%s/app-store-server/v1/applications/top?version=%s"
