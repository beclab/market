...
// UserApplicationState mirrors the user_application_state table.
type UserApplicationState struct {
	ID                int64                              `gorm:"column:id;primaryKey;autoIncrement"`
	UserApplicationID int64                              `gorm:"column:user_application_id;not null;uniqueIndex:uq_user_application_state_ua;index:idx_user_application_state_ua"`
	AppVersion        string                             `gorm:"column:app_version;size:16;not null"`
	State             string                             `gorm:"column:state;size:64;not null;default:'';index:idx_user_application_state_state"`
...
func (UserApplicationState) TableName() string { return "user_application_state" }
