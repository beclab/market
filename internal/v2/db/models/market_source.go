...
// MarketSource mirrors the market_source table.
type MarketSource struct {
	ID          int64                              `gorm:"column:id;primaryKey;autoIncrement"`
	SourceID    string                             `gorm:"column:source_id;size:50;not null;uniqueIndex:uq_market_source_source_id"`
...
func (MarketSource) TableName() string { return "market_source" }
