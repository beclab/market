...
type Application struct {
	...
	SourceID   string                             `gorm:"column:source_id;size:50;not null;uniqueIndex:uq_applications_source_app,priority:1;index:idx_applications_source_id"`
	AppID      string                             `gorm:"column:app_id;size:32;not null;uniqueIndex:uq_applications_source_app,priority:2;index:idx_applications_app_id"`
