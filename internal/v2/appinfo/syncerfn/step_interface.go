...
type SyncContext struct {
	...
	MarketSource *models.MarketSource        `json:"-"`       // Current market source being used
...
func (sc *SyncContext) SetMarketSource(source *models.MarketSource) {
	sc.MarketSource = source
}

// GetMarketSource returns the current market source
func (sc *SyncContext) GetMarketSource() *models.MarketSource {
