...
// the chartrepo package taking a hard dependency on a specific stack.
//
...
type Metrics interface {
	...
	// errKind is one of "" (success), "network", "timeout",
	// "server_error", "auth", "not_found", "business_error", "decode" —
	// a small fixed vocabulary so the observer can build labels with
	// bounded cardinality.
